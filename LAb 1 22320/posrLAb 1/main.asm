...
LOOP:
	...
	IN R24, PINC
	SBRS R24, PC4			; LEE PC4, SI ES 1 SALTA A INS
	RJMP DELAYBOUNCE
	IN R27, PINC
	SBRS R27, PC4
	CALL ADESION
...
ADESION:
	MOV R25, R20			;COUNT R20 A R25
	ADC R25, R19			;AGREGAR AL   BIT CARRY
	RET

ADDER:
	;BIT 0
	SBRC R25, 0				;SI BIT 0 ES ZERO JUMP
	SBI PORTD, PD6			;ES PD6
	SBRS R25, 0				;SI BIT 0 ES 1 JUM
	CBI PORTD, PD6			;LIMPIA PD6

	;BIT 1#
	SBRC R25, 1				;SI BIT 1 ES ZERO JUMP
	SBI PORTD, PD7			;ES QUEDA PD7
	SBRS R25, 1				;SI BIT 1 ES 1 JUMP
	CBI PORTD, PD7			;LIMPIA PD7

	;BIT 2# LO MISMO CON PB5
	SBRC R25, 2				
	SBI PORTB, PB5			
	SBRS R25, 2				
	CBI PORTB, PB5			

	;BIT 3# LO MISMO CON PB4
	SBRC R25, 3				
	SBI PORTB, PB4			
	SBRS R25, 3				
	CBI PORTB, PB4			
	;CARRY 
	SBRC R25, 4				;SI BIT 4 ES ZERO JUMP
	SBI PORTC, PC5			;ES QUEDA PC5
	SBRS R25, 4				;SI BIT 4 ES 1 JUMP
	CBI PORTC, PC5			;LIMPIA PC5

	RET                     ; RETORNO A ACCIONES